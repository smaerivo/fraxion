...
/**
 * The <CODE>InvertFilter</CODE> class provides a colour-inverting filter.
 * <P>
 ...
 * @version 21/12/2014
 */
public final class InvertFilter extends AFilter
{
	/******************
	 * PUBLIC METHODS *
	 ******************/
	...
	{
		short[] invertMask = new short[256];
		for (int i = 0; i < 256; i++) {
			invertMask[i] = (short) (255 - i);
		}

		LookupTable lookupTable = new ShortLookupTable(0,invertMask);
