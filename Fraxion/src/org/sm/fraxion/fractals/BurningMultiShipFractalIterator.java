// ----------------------------------------------------
// Filename      : BurningMultiShipFractalIterator.java
...
/**
 * The <CODE>BurningMultiShipFractalIterator</CODE> class provides an implementation of the Burning Multiship fractals.
 * <P>
 ...
 * @version 10/10/2014
 */
public final class BurningMultiShipFractalIterator extends APowerFractalIterator
{
	/****************
	 * CONSTRUCTORS *
	 ****************/
	...
	/**
	 * Creates a <CODE>BurningMultiShipFractalIterator</CODE> object.
	 */
	public BurningMultiShipFractalIterator()
	{
		setInvertYAxis(true);
	}
	...
	/**
	 * Returns the default power of 4.0.
	 *
	 * @return the default power of 4.0
	 */
	@Override
	protected ComplexNumber getDefaultPower()
	{
		return (new ComplexNumber(4.0));
	}
	...
	{
		return z.cabs().pow(fPower).add(c);
	}
}
